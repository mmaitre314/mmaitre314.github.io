...
One approach is to use [Privileged Identity Management](https://learn.microsoft.com/en-us/entra/id-governance/privileged-identity-management/pim-configure) (PIM) to limit the blast radius. Access Azure under a low-permission role like [Reader](https://learn.microsoft.com/en-us/azure/role-based-access-control/built-in-roles/general#reader) for the Copilot session, and perform just-in-time elevations to broader roles only when needed.
