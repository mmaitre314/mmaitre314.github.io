This is a blog for a very technical audience. Blog entries are concise and to the point. Just enough background info is provided to set context, but no more. Links are provided for interested readers to read further. Blog is hosted on GitHub and processed by Jekyll.

## Style

- First-person pronouns ("I", "we") are avoided. Use impersonal or imperative style instead (e.g. "Create a file..." not "We create a file...").
